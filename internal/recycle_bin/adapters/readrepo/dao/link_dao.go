...
import (
	"context"
	"gorm.io/gorm"
	po2 "shortlink/internal/common/persistence/po"
	types2 "shortlink/internal/common/types"
)
...
func (d *LinkDao) GetLink(ctx context.Context, id types2.LinkID) (po2.Link, error) {
	var link po2.Link
...
func (d *LinkDao) PageLink(
	...
	page int,
	size int,
) (res *types2.PageResp[LinkDTO], err error) {
	rawSql := `
